        ...
        <table className="w-full">
          <thead>
            <tr>
              ...
              <th className="table-header text-center">Trend <span className="text-xs font-normal">(90 days)</span></th>
            </tr>
          </thead>
          <tbody>
            {currentPublishers.map((publisher, index) => (
              <tr key={publisher.id} className={index % 2 === 0 ? 'table-row' : 'table-row-alt'}>
                ...
                <td className="py-3 px-4 text-center">
                  <div>{formatHours(publisher.avgRemediationTimeHours)}</div>
                </td>
                <td className="py-3 px-4 text-center">
                  {getTrendIcon(publisher.trend)}
                </td>
...
export const EnhancedComplianceOverviewDemo: React.FC = () => {
  const mockPublishers: PublisherComplianceData[] = [
    { id: '1', name: 'AcmeCo', itemsScanned: 124, violationsFound: 18, violationRate: 14.5, avgRemediationTimeHours: 24.5, trend: -3.2 },
    { id: '2', name: 'BetaInc', itemsScanned: 86, violationsFound: 4, violationRate: 4.7, avgRemediationTimeHours: 8.3, trend: 6.8 },
    { id: '3', name: 'GamesCo', itemsScanned: 156, violationsFound: 22, violationRate: 14.1, avgRemediationTimeHours: 36.2, trend: -7.3 },
    { id: '4', name: 'TechFirm', itemsScanned: 67, violationsFound: 5, violationRate: 7.5, avgRemediationTimeHours: 12.8, trend: 1.4 },
    { id: '5', name: 'MediaGroup', itemsScanned: 93, violationsFound: 8, violationRate: 8.6, avgRemediationTimeHours: 18.7, trend: 0 },
    { id: '6', name: 'FinanceDaily', itemsScanned: 45, violationsFound: 4, violationRate: 8.9, avgRemediationTimeHours: 6.2, trend: 4.2 },
    { id: '7', name: 'CreditSource', itemsScanned: 78, violationsFound: 9, violationRate: 11.5, avgRemediationTimeHours: 48.3, trend: -5.6 },
    { id: '8', name: 'CardReviews', itemsScanned: 112, violationsFound: 6, violationRate: 5.4, avgRemediationTimeHours: 10.5, trend: 8.7 }
  ];
