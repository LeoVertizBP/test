    ...
    >
      <div className="space-y-5">
        <div className="p-3 bg-background rounded text-sm text-text-secondary mb-4">
          <p className="mb-2">Select at least one scan job or publisher to export flags.</p>
        ...
        <FormField 
          label="Scan Jobs" 
          htmlFor="scanJobs"
          helpText="Select specific scan jobs to export flags from"
        >
          <MultiSelect
            id="scanJobs"
            options={scanJobs}
